...
from dataclass_dst import DSTMultiWozData
...
if __name__ =="__main__":
    ...
    labeled_dataset = DSTMultiWozData(tokenizer, args.labeled_data_path, 'train' , short = args.short) 
    valid_dataset = DSTMultiWozData(tokenizer,  args.valid_data_path, 'valid' , short = args.short)
    test_dataset = DSTMultiWozData(tokenizer,  args.test_data_path, 'test' , short = args.short)
